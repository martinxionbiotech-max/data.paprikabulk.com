---title: ISO Certification Glossary
description: ISO certification guide for paprika suppliers — ISO 9001, 22000, and 14001 requirements.
...
**Why ISO Matters for Paprika:**
ISO certification provides independent verification that a supplier operates to internationally recognized standards. It is often a prerequisite for supplying major food manufacturers and retailers. For Chinese paprika exporters, ISO 9001 and ISO 22000 are the most commonly requested certifications.
...
| Hazard analysis (8.5) | Biological, chemical, physical hazards for each step | See [HACCP Certification Guide](./haccp.md) — Table in Section 2 |
...
|----------------|-------------|
| [HACCP Certification Guide](./haccp.md) | HACCP is the operational core of ISO 22000 |
| [Paprika Specifications Guide](../white-papers/paprika-specifications.md) | Spec limits define quality criteria for ISO 9001 |
| [ASTA Color Value Guide](../white-papers/asta-color-value-guide.md) | Quality objective: consistent ASTA within tolerance |
| [Paprika Supply Chain Guide](../white-papers/paprika-supply-chain.md) | Process flow for ISO 9001/22000 documentation |
| [Paprika Grades Explained](../white-papers/paprika-grades-explained.md) | Grade consistency: key quality objective |
| [Glossary - Paprika Quality Parameters](../glossary/index.md) | Definitions of ISO, QMS, PDCA, OPRP |
