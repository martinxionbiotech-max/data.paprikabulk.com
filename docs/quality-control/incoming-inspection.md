...
description: Paprika incoming inspection checklist — receiving inspection template for shipment verification.
...
- [ASTA Color Test Record](asta-color-test.md) — QC lab follow-up
- [Particle Size Test Record](particle-size-test.md) — QC lab follow-up
- [COA Template](coa-template.md) — Batch certification standard
- [Container Loading Inspection](container-loading-inspection.md) — Supplier side (outgoing)
- [CAPA Report](capa-report.md) — For non-conformance handling
