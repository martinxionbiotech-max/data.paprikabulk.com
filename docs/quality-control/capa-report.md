...
description: CAPA report template for paprika quality incidents — root cause analysis and corrective/preventive actions.
...
# Corrective and Preventive Action (CAPA) — Standard Procedure & Report
...
- **What** action will be taken to correct the immediate issue
- **Who** is responsible
...
For each root cause, define:
- **What** systemic change prevents recurrence (SOP update, training, equipment change, additional check, new supplier requirement)
- **Who** is responsible
- **When** it must be completed
...
CAPA is closed only when:
1. All corrective and preventive actions are implemented
2. Effectiveness is verified
3. Documentation is complete
4. QC Manager and Quality Director approve
...
**Verification Completed By:** _________________ **Date:** ______________
...
**If Reopened, reason:** _______________________________________________
...
- [COA Template](coa-template.md) — Batch certification record
- [Incoming Inspection](incoming-inspection.md) — Receiving quality check
- [Supplier Audit Checklist](supplier-audit-checklist.md) — Supplier audit
- [Supplier Scorecard](supplier-scorecard.md) — Supplier KPI tracking
- [Glossary: Acceptance Criteria](../glossary/quality-control/acceptance-criteria.md)
- [Glossary: Specification](../glossary/quality-control/specification.md)
