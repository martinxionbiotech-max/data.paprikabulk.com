---title: Sampling Procedure — ISO 948 / EC 1796
description: Paprika sampling procedure per ISO 948 — standardized sampling protocol for spice inspection including sample size, partitioning, preparation, and documentation for representative quality testing.
...
**Reference Standards:**
- **ISO 948:2022** — Spices and condiments — Sampling
- **ISO 2825:1981** — Preparation of a ground sample for analysis
- **EC Regulation 1796/2016** — Methods of sampling and analysis
- **ASTA Method 20.1** — Sample preparation section
- **AOAC Guidelines** — Sampling for mycotoxin testing
...
**For container shipments (20′ FCL ≈ 18–22 MT):** Sample **20 bags minimum**, distributed across:
- 7 bags from front of container
- 6 bags from middle
- 7 bags from rear
...
**Critical Rules:**
- Never take all samples from bags on the same pallet row.
- Never sample only from accessible bags (front/outer rows only).
- Never combine incremental samples from different lots.
...
- [Incoming Inspection](./incoming-inspection.md) — Receiving sampling at warehouse
- [ASTA Color Test Record](./asta-color-test.md) — Laboratory analysis of samples
- [CAPA Report](./capa-report.md) — Sampling deviation as CAPA trigger
- [ASTA Color Value](../glossary/spice-science/asta.md) — Analytical method
- [Acceptance Criteria](../glossary/quality-control/acceptance-criteria.md) — Pass/fail using sampled results
