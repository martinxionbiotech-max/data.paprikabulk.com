---title: Container Loading Inspection Procedure
description: Paprika container loading inspection — pre-shipment inspection for container condition and loading procedures.
...
- [Incoming Inspection Procedure](incoming-inspection.md) — Receiving counterpart
- [Glossary: Container Loading](../glossary/sourcing-trade/container-loading.md)
- [Glossary: Incoterms](../glossary/sourcing-trade/incoterms.md)
- [CAPA Report](capa-report.md) — For shipping damage claims
