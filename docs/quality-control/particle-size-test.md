---title: Particle Size Test Record
description: Paprika particle size test record — standardized sieve analysis log for specification compliance.
...
# Particle Size Distribution Test — Standard Operating Procedure & Record
...
### 3.1 Sampling
1. Obtain representative sample per [Incoming Inspection Procedure](incoming-inspection.md).
...
- **Cumulative % Retained** = Sum of % retained on this sieve + all coarser sieves above
