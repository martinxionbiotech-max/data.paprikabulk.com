---title: Mycotoxin Monitoring — Aflatoxin & Ochratoxin in Paprika
description: Paprika mycotoxin monitoring and testing guide — aflatoxin B1, B2, G1, G2 and ochratoxin A limits, EU/US regulatory thresholds, sampling protocols, HPLC testing, and supplier risk management.
...
- [Sampling Procedure](./sampling-procedure.md) — Enhanced sampling for mycotoxins
- [Microbiology](../glossary/quality-control/microbiology.md) — Mold and yeast limits
- [Pesticide Residue Management](./pesticide-residue-management.md) — Related contaminant control
- [HACCP](../certifications/haccp.md) — Mycotoxin as CCP
- [Incoming Inspection](./incoming-inspection.md) — Receiving test for imported lots
- [CAPA Report](./capa-report.md) — Corrective action protocol
