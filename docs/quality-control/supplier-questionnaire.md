---title: Supplier Questionnaire Template
description: Paprika supplier pre-qualification questionnaire — comprehensive assessment of manufacturing and quality systems.
...
# Supplier Pre-Qualification Questionnaire — Procedure & Form
...
| HACCP certified? | Yes / No (Certifying body: ______, expiry: ______) | |
...
| Third-party lab partnerships? | Yes / No (Name: ______, scope: ______) | |
...
| Drying temperature range | [___°C to ___°C] |
...
| Question | Response |
|----------|----------|
| Current customers (3 references) | 1. _______ 2. _______ 3. _______ |
...
- [Supplier Audit Checklist](supplier-audit-checklist.md) — Follow-up on-site procedure
- [Supplier Scorecard](supplier-scorecard.md) — Ongoing performance evaluation
- [Glossary: Supplier Qualification](../glossary/sourcing-trade/supplier-qualification.md)
- [Incoming Inspection Procedure](incoming-inspection.md)
