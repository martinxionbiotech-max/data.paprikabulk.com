---title: FSMA Compliance — US FDA Food Safety Modernization Act
description: FSMA US import compliance guide for paprika — Foreign Supplier Verification Program (FSVP), Preventive Controls, Food Defense, prior notice requirements, and FDA import alerts for spice imports to the United States.
category: Regulatory
keywords:
- FSMA
- FDA
...
1. **Register** with FDA — renewal every even-numbered year (October 1 – December 31).
2. **Assign a Unique Facility Identifier (UFI)** — typically a **DUNS number**.
3. **Designate a US Agent** — physical person residing in the US.
4. **Notify FDA of changes** within 60 days.
...
- [Pesticide Residue Management](../quality-control/pesticide-residue-management.md) — US tolerance requirements
- [Mycotoxin Monitoring](../quality-control/mycotoxin-monitoring.md) — Aflatoxin limits for FDA
- [Salmonella Border Detention (Case Study)](../case-studies/salmonella-border-detention.md) — Real FDA crisis scenario
- [HACCP](../certifications/haccp.md) — Preventive controls alignment
- [Codex Alimentarius](../regulatory/codex.md) — International reference standards
