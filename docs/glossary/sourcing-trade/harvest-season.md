---title: Harvest Season Glossary
description: Paprika harvest season guide by origin — Xinjiang (Aug-Oct), Hungary (Sep-Oct), Spain (Aug-Nov), Serbia (Aug-Oct), India (Feb-Apr). Seasonal pricing, availability, and procurement timing recommendations.
...
| Water Activity (a<sub>w</sub>) | 0.45–0.55 | 0.50–0.60 | 0.55–0.70 | Increases |
...
1. **Contract on new crop basis** for quality-critical applications: specify "Current year harvest only" or "New crop, harvest year 2026" on purchase orders.
2. **Time quality testing with harvest data:** when testing ASTA at receipt, compare against the supplier's harvest timing — a 30-point ASTA decline in 6 months indicates poor storage conditions.
3. **Plan testing frequency by crop age:** increase microbiological testing frequency for old crop (>6 months post-harvest) — microbial populations can increase in storage.
4. **Negotiate new crop premiums transparently:** a 10–15% premium for guaranteed new crop is standard; more than 20% suggests speculation.
5. **Build a calendar-based pricing model:** use the seasonal price curve to negotiate quarterly pricing adjustments with automatic escalation/de-escalation linked to harvest timing.

## Cross-References

- [Origin Traceability](./origin-traceability.md) — Harvest origin verification
- [ASTA](../spice-science/asta.md) — Quality decline tracking over storage
- [Storage](../../quality-control/storage.md) — Best practices for crop preservation
- [Blending](../processing/blending.md) — New-crop/old-crop blending strategy
- [Supplier Qualification](./supplier-qualification.md) — Supplier evaluation linked to harvest performance

## Frequently Asked Questions

**Q: How much ASTA loss is normal for paprika stored over 12 months?**
A: Under optimal storage (≤25°C, ≤55% RH, oxygen-barrier packaging, dark): 15–25% ASTA loss over 12 months. Under marginal storage (30°C, 65% RH, standard PP bags): 30–50% loss. Under poor storage (>35°C, >70% RH, open packaging): 60–80% loss with visible browning within 6 months. Always request the harvest year and compare against expected degradation.

**Q: Can paprika from the Southern Hemisphere (e.g., Peru, South Africa) fill the Northern Hemisphere pre-harvest gap?**
...
**Q: Do Chinese paprika growers use any techniques to extend the harvest window?**
A: Yes: (1) staggered planting — spreading planting dates 2–4 weeks apart extends harvest by 3–4 weeks; (2) multi-variety cultivation — early-maturing (85–95 day) and late-maturing (110–120 day) varieties grown side by side; (3) protective cultivation — plastic mulch tunnels advance harvest by 2–3 weeks; (4) drip irrigation timing adjustment — controlled water stress can delay or advance maturity by 5–10 days.
...
**Q: How does Dinweys ensure year-round availability despite the seasonal harvest cycle?**
